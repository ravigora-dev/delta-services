  ...
  const features = [
    {
      icon: Smartphone,
      title: 'Mobile First',
      description: 'Designed with mobile users in mind, ensuring perfect functionality across all devices.',
      color: 'blue'
    },
    {
      icon: Zap,
      title: 'Lightning Fast',
      description: 'Optimized performance with smooth animations and instant interactions.',
      color: 'yellow'
    },
    {
      icon: Palette,
      title: 'Beautiful Design',
      description: 'Modern aesthetics with glassmorphism effects and gradient accents.',
      color: 'purple'
    },
    {
      icon: Code,
      title: 'Clean Code',
      description: 'Well-structured, maintainable code built with React and TypeScript.',
      color: 'green'
    },
    {
      icon: Shield,
      title: 'Accessible',
      description: 'Built with accessibility in mind, ensuring usability for everyone.',
      color: 'red'
    },
    {
      icon: Rocket,
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Integrate this beautiful navigation system into your project and enhance your user experience today.
            </p>
